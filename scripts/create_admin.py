...
def create_system_admin():
    ...
    try:
        ...
        if existing_users > 0:
            logger.warning("Users already exist in the database. Skipping admin creation.")
            return
        
        # Create system admin user
        auth_service = AuthService()
        hashed_password = auth_service.get_password_hash("admin123")  # Change this password!
        ...
        logger.info("⚠️  IMPORTANT: Change the default password 'admin123' after first login!")
