#!/usr/bin/env python3
"""
Migration script to add extended fields to chatbot_configs table.
Run this script to add the new fields for enhanced chatbot configuration.
"""
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            result = conn.execute(text("""
                ...
                AND column_name IN (
                    'company_name', 'specializations', 'friendly_tone', 
                    'professional_style', 'suggestive_responses', 'manager_handover',
...
if __name__ == "__main__":
    migrate_chatbot_config_extended()
