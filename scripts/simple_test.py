...
def test_database_structure():
    ...
    try:
        ...
        required_columns = ['id', 'name', 'prompt', 'business_context', 'language', 'force_language', 'is_active', 'created_at', 'updated_at']
        ...
        try:
            ...
            db.execute(text("DELETE FROM chatbot_configs WHERE id = :id"), {'id': new_id})
            db.commit()
