        ...
        if response.status_code == 200:
            ...
            for category, configs in settings.items():
                ...
                for key, value in configs.items():
                    ...
                    display_value = "***" if key in ["api_key", "bot_token", "jwt_secret"] else value
...
def test_save_openai_settings(token):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"❌ Failed to save OpenAI settings: {response.status_code} - {response.text}")
            return False
    except Exception as e:
...
def test_save_telegram_settings(token):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"❌ Failed to save Telegram settings: {response.status_code} - {response.text}")
            return False
    except Exception as e:
...
def test_save_system_settings(token):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"❌ Failed to save system settings: {response.status_code} - {response.text}")
            return False
    except Exception as e:
...
def test_save_security_settings(token):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"❌ Failed to save security settings: {response.status_code} - {response.text}")
            return False
    except Exception as e:
...
def test_bulk_settings(token):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"❌ Failed to save bulk settings: {response.status_code} - {response.text}")
            return False
    except Exception as e:
